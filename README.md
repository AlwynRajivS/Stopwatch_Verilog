...
A fully modular FPGA-based digital timer designed using Verilog HDL.
The system integrates a clock divider, state machine, counter, and multiplexed 7-segment display controller.
...
Reduces high-frequency FPGA clock to a slower clock suitable for timer operation.
...
Increments based on divided clock
...
Press Start → Timer begins counting.

Press Stop → Timer pauses.

Press Increment → Counter increments once.

Press Reset → Counter resets to zero.

Switch swt enables/disables display.
